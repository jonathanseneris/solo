...
module.exports = function(app) {
  ...
  app.param('code', transactionController.findUrl);

  app.route('/')
    .get(transactionController.allLinks)
    .post(transactionController.newLink);

  app.get('/:code', transactionController.navToLink);
